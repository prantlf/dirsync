...
[assembly: AssemblyDescription(@"Makes the content of a target directory the same as of the " +
    "source one. Deletes extraneous, updates modified and creates new folders and files from, " +
    "in and to the target directory in the optimal order. Works recursively in subdirectories.")]
